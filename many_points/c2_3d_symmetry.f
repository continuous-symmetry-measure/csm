...
c----------------------------------------------------------
     ...
     *     STATUS='UNKNOWN',FORM='FORMATTED')
      ...
      DO I=1,21
         ...
         CALL C2_SYMM(N, PX, PY, PZ, NUMBERS, SYM, DIR_COS)
...
C*********************************************************************
      ...
      SUBROUTINE C2_SYMM(N_POINT, PX, PY, PZ, NUMBERS, SYM, DIR_COS)
     ...
     *                PZ(JJ)*DIR_COS(3)
         ...
         END DO
         CALL CALC_C2_SYMM(CX, CY, CZ, SIG2, DIR_COS)
         SYM = SYM+2.0d0*SIG2
...
C*********************************************************************
      ...
      SUBROUTINE CALC_C2_SYMM(CX, CY, CZ, SIG2, DIR_COS)
