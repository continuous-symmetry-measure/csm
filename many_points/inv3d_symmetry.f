...
c----------------------------------------------------------
     ...
     *     STATUS='UNKNOWN',FORM='FORMATTED')
      ...
      DO I=1,21
         ...
         CALL INV_SYMM(N, PX, PY, PZ, NUMBERS, SYM)
...
C*********************************************************************
      ...
      SUBROUTINE INV_SYMM(N_POINT, PX, PY, PZ, NUMBERS, SYM)
      ...
      DO I=1,N_POINT,2
         ...
         END DO
         CALL CALC_INV_SYMM(CX, CY, CZ, SIG2)
         SYM = SYM+2.0d0*SIG2
...
C*********************************************************************
      ...
      SUBROUTINE CALC_INV_SYMM(CX, CY, CZ, SIG2)
