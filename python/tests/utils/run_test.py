...
class Expected:
    def __init__(self, dict):
        ...
        self.symmetric_structure=MoleculeReader.from_string(dict['symmetric'], 'xyz', initialize=False)._Q
        self.molecule=MoleculeReader.from_string(dict['normalized'], 'xyz')
